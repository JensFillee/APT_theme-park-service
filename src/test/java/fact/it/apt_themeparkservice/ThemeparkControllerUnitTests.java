...
public class ThemeparkControllerUnitTests {
    ...
    private final Themepark themepark1 = new Themepark("1","Themepark1","straatlaan 1", 5000,"156555");
    private final Themepark themepark2 =  new Themepark("2","Themepark2","straatlaan 2", 8000,"156444");

    private final List<Themepark> allThemeparks = Arrays.asList(themepark1, themepark2);

    @Test
    public void givenThemepark_whenGetThemeparkByThemeparkCode_thenReturnJsonThemepark() throws Exception {

        given(themeparkRepository.findThemeparkByThemeparkCode("156555")).willReturn(themepark1);
    ...
    public void givenThemeparks_whenGetThemeparkByName_thenReturnJsonThemeparks() throws Exception {
        ...
        given(themeparkRepository.findThemeparkByNameContaining("Themepark")).willReturn(allThemeparks);
